...
/***/ function(module, exports, __webpack_require__) {
	...
	var _calculate = __webpack_require__(94);
	...
	var ClacApp = function (_React$Component) {
	  _inherits(ClacApp, _React$Component);

	  function ClacApp() {
	    _classCallCheck(this, ClacApp);

	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(ClacApp).call(this));

	    _this.state = {
	      input: ''
	    };
	    _this.keypadKeys = [_this._keyPress('1'), _this._keyPress('2'), _this._keyPress('3'), _this._keyPress('4'), _this._keyPress('5'), _this._keyPress('6'), _this._keyPress('7'), _this._keyPress('8'), _this._keyPress('9'), _this._keyPress('.'), _this._keyPress('0'), {
	      label: '$',
	    ...
	    _this.computeKey = {
	      ...
	      action: function action() {
	        _this.setState({
	          input: '$' + Number((0, _calculate2.default)(_this.state.input)).toFixed(2)
	        });
	      }
	    };
	    ...
	    _this.clearKey = {
	      ...
	      action: function action() {
	        _this.setState({
	          input: _this.state.input.slice(0, _this.state.input.length - 1)
	        });
	      }
	    };

	    _this.functionKeys = [_this._keyPress('+'), _this._keyPress('-'), _this._keyPress('x'), _this._keyPress('÷'), {
	      label: 'C',
	      action: function action() {
	        _this.setState({
	          input: ''
	  ...
	  _createClass(ClacApp, [{
	    key: '_keyPress',
	    value: function _keyPress(str) {
	      var _this2 = this;
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(_index4.default, { input: this.state.input || '0' }),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Keypad = function (_React$Component) {
	  ...
	  _createClass(Keypad, [{
	    key: '_createButton',
	    value: function _createButton(label, action) {
	      return _react2.default.createElement(
	        'div',
	        { className: 'keypad__cell' },
	        _react2.default.createElement(
	          _button2.default,
	          { key: label, clickHandler: action },
	          label
	        )
	      );
	    }
	    ...
	    value: function render() {
	      ...
	      var computeKey = this._createButton(this.props.computeKey.label, this.props.computeKey.action);
	      var clearKey = this._createButton(this.props.clearKey.label, this.props.clearKey.action);
	      var buttons = this.props.keypad.map(function (k) {
	        return _this2._createButton(k.label, k.action);
	      });
	      var functionKeys = this.props.functionKeys.map(function (k) {
	        return _this2._createButton(k.label, k.action);
	      });
	      return _react2.default.createElement(
	        'div',
	        ...
	        _react2.default.createElement(
	          'div',
	          { className: 'keypad__numpad' },
	          buttons,
	          _react2.default.createElement(
	            'div',
	            { className: 'keypad__compute-row' },
	            _react2.default.createElement(
	              'div',
	              { className: 'keypad__compute' },
	              computeKey
	            ),
	            _react2.default.createElement(
	              'div',
	              { className: 'keypad__clear' },
	              clearKey
	            )
	          )
	        ),
	        _react2.default.createElement(
	          'div',
	          { className: 'keypad__function-keys' },
	          functionKeys
	        )
	      );
	    }
	...
	Keypad.propTypes = {
	  keypad: _react2.default.PropTypes.array,
	  functionKeys: _react2.default.PropTypes.array,
	  computeKey: _react2.default.PropTypes.object,
	  clearKey: _react2.default.PropTypes.object
	};
...
/***/ function(module, exports) {
	...
	function factor(input, op, fn) {
	  var srt = input.charAt(0) === '-' ? 1 : 0;
	  var opIndex = input.indexOf(op, srt);
	  if (opIndex === -1) {
	    return input;
	  }
	  var termEnd = findNonNum(input.slice(opIndex + 1, input.length)) + opIndex + 1;
	  var curTerm = input.slice(0, termEnd < 0 ? input.length : termEnd);
	  var split = curTerm.split(op);
	  var calculated = fn(Number(split[0]), Number(split[1]));
	  return factor(calculated + input.slice(curTerm.length, input.length), op, fn);
	}

	exports.default = function (input) {
	  var nosign = input.replace(/\$/g, '');
	  var plus = factor(nosign, '+', function (a, b) {
	    return a + b;
	  });
	  var sub = factor(plus, '-', function (a, b) {
	    return a - b;
	  });
	  var division = factor(sub, '÷', function (a, b) {
	    return a / (b === 0 ? 1 : b);
	  });
	  var multi = factor(division, 'x', function (a, b) {
	    return a * b;
	  });
	  return multi;
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.i, ".calc-display {\n  font-size: 4rem;\n  padding: 2rem;\n  margin: .25rem;\n  background-color: white;\n  border-radius: .25rem;\n  box-shadow: 0 0 0.5px rgba(0, 0, 0, 0.2);\n  letter-spacing: 0.125rem; }\n", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.i, ".keypad__cell {\n  padding: .25rem; }\n\nbutton {\n  font-family: 'Fira', sans-serif;\n  font-size: 2rem;\n  border-radius: .25rem;\n  border: none;\n  background-color: #fff;\n  box-shadow: 0 0 0.5px rgba(0, 0, 0, 0.2), 0.2rem 0.2rem 3px rgba(0, 0, 0, 0.2);\n  transition: transform .1s ease-out, box-shadow .1s ease-out;\n  cursor: pointer;\n  width: 100%;\n  height: 100%; }\n\nbutton:active {\n  box-shadow: 0 0 0.5px rgba(0, 0, 0, 0.2), 0 0 1px rgba(0, 0, 0, 0.3);\n  transform: translateY(3px);\n  outline: 0; }\n\nbutton:focus {\n  outline: 0; }\n", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/sass-loader/index.js!./display.scss", function() {
				var newContent = require("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/sass-loader/index.js!./display.scss");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.i, ".keypad__numpad {\n  width: 75%;\n  vertical-align: top;\n  display: inline-block; }\n\n.keypad__numpad .keypad__cell {\n  display: inline-block;\n  width: 33.33%;\n  height: 33.33%;\n  max-height: 6rem; }\n\n.keypad__numpad .keypad__compute .keypad__cell {\n  width: 66.66%; }\n\n.keypad__function-keys {\n  display: inline-block;\n  width: 25%; }\n\n.keypad__function-keys button {\n  max-height: 5.5rem;\n  vertical-align: middle; }\n\n.keypad__compute .keypad__cell {\n  float: left; }\n", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/sass-loader/index.js!./keypad.scss", function() {
				var newContent = require("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/sass-loader/index.js!./keypad.scss");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
